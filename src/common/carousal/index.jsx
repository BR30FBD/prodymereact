...
<input type="checkbox" className='box-value'  style={{width:"20px"}} id={item.product_id} onClick={(e)=>handlecart5(e)}/><h5 className='h3-font' style={{width:"100%"}} >Add To Cart</h5>
</div>
                </footer>
              </div>
            </div>
